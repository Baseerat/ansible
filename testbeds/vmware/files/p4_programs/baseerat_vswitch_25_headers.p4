...
parser parse_bitmap_hdr14 {
    ...
    return parse_bitmap_hdr15;
}

header bitmap_hdr_t bitmap_hdr15_;

parser parse_bitmap_hdr15 {
    extract(bitmap_hdr15_);
    return parse_bitmap_hdr16;
}

header bitmap_hdr_t bitmap_hdr16_;

parser parse_bitmap_hdr16 {
    extract(bitmap_hdr16_);
    return parse_bitmap_hdr17;
}

header bitmap_hdr_t bitmap_hdr17_;

parser parse_bitmap_hdr17 {
    extract(bitmap_hdr17_);
    return parse_bitmap_hdr18;
}

header bitmap_hdr_t bitmap_hdr18_;

parser parse_bitmap_hdr18 {
    extract(bitmap_hdr18_);
    return parse_bitmap_hdr19;
}

header bitmap_hdr_t bitmap_hdr19_;

parser parse_bitmap_hdr19 {
    extract(bitmap_hdr19_);
    return parse_bitmap_hdr20;
}

header bitmap_hdr_t bitmap_hdr20_;

parser parse_bitmap_hdr20 {
    extract(bitmap_hdr20_);
    return parse_bitmap_hdr21;
}

header bitmap_hdr_t bitmap_hdr21_;

parser parse_bitmap_hdr21 {
    extract(bitmap_hdr21_);
    return parse_bitmap_hdr22;
}

header bitmap_hdr_t bitmap_hdr22_;

parser parse_bitmap_hdr22 {
    extract(bitmap_hdr22_);
    return parse_bitmap_hdr23;
}

header bitmap_hdr_t bitmap_hdr23_;

parser parse_bitmap_hdr23 {
    extract(bitmap_hdr23_);
    return parse_bitmap_hdr24;
}

header bitmap_hdr_t bitmap_hdr24_;

parser parse_bitmap_hdr24 {
    extract(bitmap_hdr24_);
